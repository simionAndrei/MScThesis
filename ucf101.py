    ...
    for i in range(len(video_names)):
        ...
        if n_samples_for_each_video == 1:
            ...
            for j in range(1, n_frames, step):
                ...
                if j + sample_duration < n_frames + 1:
...
class UCF101(data.Dataset):
    ...
    def __init__(self,
        ...
        self.add_random_per_clip = add_random_per_clip
        ...
        if self.is_simclr_transform:
            ...
            if self.temporal_transform is not None:
                ...
                for img_i, img_j in zip(clip_i, clip_j):
                    ...
                    if self.add_random_per_clip:
                        img_i = self.spatial_transform(img_i, seed1)
                    else:
                    ...
                    if self.add_random_per_clip:
                        img_j = self.spatial_transform(img_j, seed2)
                    else:
...
def get_ucf_dataset(video_path, annotation_path, dataset_type,
    sampling_method, spatial_transform, temporal_transform, temporal_step = 0,
    stack_clip = False, is_simclr_transform = False, 
    apply_same_per_clip = False, add_random_per_clip = False):

    data = UCF101(video_path, annotation_path, dataset_type,
        ...
        apply_same_per_clip = apply_same_per_clip, add_random_per_clip = add_random_per_clip, 
        n_samples_for_each_video = 4,  sample_duration = 32)
