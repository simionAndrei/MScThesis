...
class UCF101(data.Dataset):
    ...
    def __init__(self,
        ...
        self.is_moco_transform = is_moco_transform
    ...
    def __getitem__(self, index):
        ...
        if self.stack_clip and not self.is_moco_transform:
            clip = torch.stack(clip, 0).permute(1, 0, 2, 3)

        if self.stack_clip and self.is_moco_transform:
...
def get_ucf_dataset(video_path, annotation_path, dataset_type,
    ...
    stack_clip = False, is_moco_transform = False, apply_same_per_clip = False):
    ...
    data = UCF101(video_path, annotation_path, dataset_type,
        ...
        stack_clip = stack_clip, is_moco_transform = is_moco_transform,
